...
def evidence_icon(strength: str) -> str:
...
if not st.session_state.get("api_key"):
    st.info("🔑 Enter your Anthropic API key in the sidebar to begin analysis.", icon="ℹ️")
...
if result_key in st.session_state:
    ...
    if patterns:
        ...
        for p in patterns:
            ...
            ev_icon = evidence_icon(p.get("evidence_strength", "weak"))
            ...
            <div class='pattern-card'>
                ...
                <div class='cause-effect'>
                    ...
                    {f"<div class='temporal-chip'>⏱ {gap} days</div><div class='arrow-box'>→</div>" if gap > 1 else ""}
            ...
            with st.expander(f"🔬 Reasoning trace for: {p.get('title','Pattern')}", expanded=False):
...
<div style='text-align: center; color: #334155; font-size: 12px; font-family: JetBrains Mono; border-top: 1px solid #1e2a45; padding-top: 16px;'>
    Clary · Ask First Health Reasoning Engine · Powered by Gemini 1.5 Flash
</div>
""", unsafe_allow_html=True)
